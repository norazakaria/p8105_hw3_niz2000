...
In this step, I used the tidied accelerometer dataset, and aggregated activity accross each the 1440 minutes of each of the 35 days to create a new total_activity variable. I created a table demonstrating these day_number and these totals. I also included the new variable day_type in the table, hypothesizing that perhaps there is a trend in activity level and whether or not it was a weekend or weekday. 
```{r}
