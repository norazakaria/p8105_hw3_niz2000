...
used to interpret observations in the data and that are relevant to
future analyses in this problem include the “order\_id,” “product\_id,”
“reordered,” “days\_since\_prior\_order,” “product\_name,” “aisle,”
and the “department” variables. Using the dataset and these key
variables, information about specific ordering behavior for an
individual can be determined. For example, order identifier 1
(order\_id) ordered product number 49302 (product\_id=49302), or
Bulgarian Yogurt (product\_name), from the dairy eggs department
(department), and reordered the product an additional time (reordered).
